...
public class PasswordGenerator {
  ...
  public static class Builder {
    ...
    public Builder requiredUpperCase() {
      return requiredUpperCase(true);
    }

    public Builder requiredUpperCase(boolean required) {
      upperCaseRequired = required;
      return this;
    }

    public Builder requiredLowerCase() {
      return requiredLowerCase(true);
    }

    public Builder requiredLowerCase(boolean required) {
      lowerCaseRequired = required;
      return this;
    }

    public Builder requiredDigits() {
      return requiredDigits(true);
    }

    public Builder requiredDigits(boolean required) {
      digitsRequired = required;
      return this;
    }

    public Builder requiredPunctuation() {
      return requiredPunctuation(true);
    }

    public Builder requiredPunctuation(boolean required) {
    ...
    public PasswordGenerator build() throws IllegalStateException {
      ...
      String generatorPool = ambiguousAllowed ? pool.toString() : pool.toString().replaceAll(AMBIGUOUS, "");
